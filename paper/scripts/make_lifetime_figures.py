#!/usr/bin/env python3
"""Regenerate Fig. 3 (two panels: perplexity under the aging trace and the paired
improvement per timestep) from the archived multiseed Phase-4 rows (seed, policy, t, r, nll).
